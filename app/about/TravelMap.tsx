...
const PLACES: Place[] = [
  ...
  { id: "singapore", name: "Singapore", location: [1.35, 103.82], labelOffset: [-32, 38] },
  { id: "jakarta", name: "Jakarta", location: [-6.2, 106.82], labelOffset: [26, 16] },
...
export function TravelMap() {
  ...
  return (
    <figure className={`about-travel-map${dragging ? " is-dragging" : ""}`}>
      ...
      >
        <defs>
          <path id="about-globe-note-path" d="M 42 246 C 42 336, 122 388, 278 392" />
        </defs>
        <text>
          <textPath href="#about-globe-note-path" startOffset="47%" textAnchor="middle">
